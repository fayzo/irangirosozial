...
class Blog extends Crowfund{
    ...
    public function blogs($pages,$categories,$user_id){
        ...
        $query= $mysqli->query("SELECT * FROM users U Left JOIN blog B ON B. user_id3 = B. user_id3 WHERE B. categories_blog ='$categories' AND B. blog_post != 'posted' ORDER BY created_on3 Desc Limit $showpages,6");
        ?>
          ...
          ?>
              ...
              <div class="col-md-12 mb-2">
                <div class="card flex-md-row shadow-sm h-md-100 border-0">
                  <img class="card-img-left flex-auto" height="130px" width="100px" src="<?php echo BASE_URL_PUBLIC ;?>uploads/Blog/<?php echo $row['photo'] ;?>" alt="Card image cap">
