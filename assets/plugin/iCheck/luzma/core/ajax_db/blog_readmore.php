            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="blog-post mb-0">
                        ...
                        <img class="float-left mr-2 shadow-sm" src="<?php echo BASE_URL_LINK.'image/img/img/045.jpg' ;?>" width="350px" height="auto" />
                                ...
                                <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:980px;overflow:hidden;"> <!--width:980px;height:380px -->
                                      <?php 
                                        ...
                                        for ($i=0; $i < count($splice); ++$i) { 
                                            ?>
                                      <div class="imageblogViewPopup more"  data-blog="<?php echo $user["blog_id"] ;?>">
                                      <img data-u="image" src="<?php echo BASE_URL_PUBLIC."uploads/Blog/".$splice[$i] ;?>"
                                          alt="Photo" >
                                      </div>
                                      <?php } ?>
             ...
             if (array_diff($fileActualExt,$allower_ext) == false) {
               ...
               <?php if ($count === 1) { ?>
                       ...
                       <div class="mt-2">
                            <?php 
                               ...
                               $expode = explode("=",$file); ?>
                             <div class="imageblogViewPopup more"  data-blog="<?php echo $user["blog_id"] ;?>">
                                <img src="<?php echo BASE_URL_PUBLIC."uploads/Blog/".$expode[0] ;?>"
                                    alt="Photo" >
                             </div>
                       </div>
               ...
               <?php }else if ($count === 2) { ?>
                         ...
                         <?php 
                               ...
                               for ($i=0; $i < count($splice); ++$i) { 
                                   ...
                                   <div class="mt-2">
                                         <div class="imageblogViewPopup more"  data-blog="<?php echo $user["blog_id"] ;?>">
                                         <img src="<?php echo BASE_URL_PUBLIC."uploads/Blog/".$splice[$i] ;?>"
                                             alt="Photo" >
                                         </div>
                                   </div>
                             <?php } ?>
               ...
               <?php }else if ($count === 3) { ?>
                  ...
                  <?php }else if ($count > 3) { ?>
                            ...
                            <span class="btn btn-primary imageblogViewPopup  float-right" data-blog="<?php echo $user["blog_id"] ;?>" > View More photo  <i class="fa fa-picture-o"></i> >>> </span>
                              ...
                              <h5 class="mt-3"> Comments</h5>
                                ...
                                <div class="input-group mt-2">
                                    <input class="form-control form-control-sm" id="commentField" type="text"
                                        name="comment" data-blog="<?php echo $user['blog_id'];?>"
                                        placeholder="Reply to  <?php echo $user['username'] ;?>">
                                    <div class="input-group-append">
                                        <span class="input-group-text btn" style="padding: 0px 10px;"  <?php if(isset($_SESSION['key'])){ echo 'id="blog_Comment"'; }else{ echo 'id="login-please" data-login="1"'; } ?>
