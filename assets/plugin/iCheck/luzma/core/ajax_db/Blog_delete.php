...
if (isset($_POST['deleteTweetHome']) && !empty($_POST['deleteTweetHome'])) {
    ...
    $blog->deleteLikesBlog($tweet_id,$user_id);
}

if (isset($_POST['showpopupdelete']) && !empty($_POST['showpopupdelete'])) {
    $user_id= $_SESSION['key'];
	$blog_id= $_POST['showpopupdelete'];
	$blog_user_id= $_POST['deleteBlog'];
    $tweet=$blog->blog_getPopupTweet($user_id,$blog_id,$blog_user_id);
    ?>
      ...
      <div class="wrap5">
        <div class="post-popup-body-wrap" style="top: 15%;">
            ...
            <span id='responseDeletePost'></span>
                        ...
                        <div class="card-body d-flex flex-column align-items-start">
                            ...
                            <?php 
                                ...
                                <ul class="list-inline mb-0" style="list-style-type: none;">  
                                    ...
                                    <?php if($tweet['blog_id'] == $tweet['retweet_blog_id']){ ?>
                                            <li class=" list-inline-item"><button <?php if(isset($_SESSION['key'])){ echo 'class="share-btn blog-retweeted0 text-sm mr-2" data-blog"'.$tweet['blog_id'].'"  data-user="'.$tweet['user_id3'].'"'; }else{ echo 'id="login-please" class="more float-right" data-login="1"'; } ?>  >
                                    ...
                                    <?php }else{ ?>
                                            <li class=" list-inline-item"><button <?php if(isset($_SESSION['key'])){ echo 'class="share-btn blog-retweet0 text-sm mr-2" data-blog"'.$tweet['blog_id'].'"  data-user="'.$tweet['user_id3'].'"'; }else{ echo 'id="login-please" class="more float-right" data-login="1"'; } ?>  >
                                    ...
                                    <?php if($tweet['like_on'] == $tweet['blog_id']){ ?>
                                        <li  class=" list-inline-item"><button <?php if(isset($_SESSION['key'])){ echo 'class="unlike-blog-btn text-sm  mr-2"'; }else{ echo 'id="login-please" class="more float-right" data-login="1"'; } ?> data-blog="<?php echo $tweet['blog_id']; ?>" data-user="<?php echo $tweet['user_id']; ?>">
                                        <i class="fa fa-heart-o mr-1" style="color: red"> <span class="likescounter"><?php echo $tweet['likes_counts'] ;?> 343</span></i></button></li>
                                    <?php }else{ ?>
                                        <li  class=" list-inline-item"><button <?php if(isset($_SESSION['key'])){ echo 'class="unlike-blog-btn text-sm  mr-2"'; }else{ echo 'id="login-please" class="more float-right" data-login="1"'; } ?> data-blog="<?php echo $tweet['blog_id']; ?>" data-user="<?php echo $tweet['user_id']; ?>">
                                        <i class="fa fa-heart-o mr-1" > <span class="likescounter">  <?php if ($tweet['likes_counts'] > 0){ echo $tweet['likes_counts'];}else{ echo '';} ?></span>343</span></i></button></li>
                                    <?php } ?>
                ...
                <button class="delete-it-blog  btn btn-primary btn-md float-right ml-3" type="submit">Delete</button>
