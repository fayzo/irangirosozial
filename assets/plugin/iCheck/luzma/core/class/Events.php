    ...
    public function eventsList($pages,$categories,$user_id)
    {
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 border-0 h-md-250" style="box-shadow:0 0 0.5ch 0.5ch rgba(35, 35, 32, 0.15);">
            <img class="card-img-left flex-auto" width="200px" height="250px" src="<?php echo BASE_URL_PUBLIC ;?>uploads/events/<?php echo $row['photo'] ;?>" alt="Card image cap">
          ...
          ?>
              ...
              <div class="col-md-12 mb-2">
                <div class="card flex-md-row shadow-sm h-md-100 border-0">
                  <img class="card-img-left flex-auto" height="130px" width="100px" src="<?php echo BASE_URL_PUBLIC ;?>uploads/events/<?php echo $row['photo'] ;?>" alt="Card image cap">
